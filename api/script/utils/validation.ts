...
module Validation {
  ...
  export function isValidKeyField(val: any): boolean {
    return (
      getStringValidator(/*maxLength=*/ 100, /*minLength=*/ 10)(val) &&
      ALLOWED_KEY_CHARACTERS_TEST.test(val)
    )
  }
  ...
  export function isValidUpdateCheckRequest(
    updateCheckRequest: restTypes.UpdateCheckRequest,
  ): boolean {
  ...
  export function validateAccessKeyRequest(
    accessKey: restTypes.AccessKeyRequest,
    isUpdate: boolean,
  ): ValidationError[] {
    const fields: FieldDefinition = {
  ...
  export function validateApp(
    app: restTypes.App | storageTypes.App,
    isUpdate: boolean,
  ): ValidationError[] {
    const fields: FieldDefinition = {
  ...
  export function validateDeployment(
    deployment: restTypes.Deployment,
    isUpdate: boolean,
  ): ValidationError[] {
    const fields: FieldDefinition = {
  ...
  export function validatePackageInfo(
    packageInfo: restTypes.PackageInfo,
    allOptional: boolean,
  ): ValidationError[] {
    const fields: FieldDefinition = {
